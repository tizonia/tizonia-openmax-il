 ...
 *
 * @brief  Tizonia OpenMAX IL OSAL - libtizosal internal declarations
 *
 * @internal
 *
 */
...
/**
 * Value struct used in the Tizonia OpenMAX IL config file data structure
 *
 * @private
 */
...
/**
 * Key-value pair structure used in the Tizonia OpenMAX IL config file data
 * structure
 *
 * @private
 */
...
/**
 * Handle to the Tizonia OpenMAX IL config file data structure
 *
 * @private
 */
