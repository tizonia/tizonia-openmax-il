...
instantiate_pcm_port (OMX_HANDLETYPE ap_hdl)
{
  ...
  TIZ_LOG (TIZ_LOG_TRACE, "Inititializing the test component's pcm port");
...
instantiate_config_port (OMX_HANDLETYPE ap_hdl)
{
  ...
  TIZ_LOG (TIZ_LOG_TRACE, "Inititializing the test component's config port");
...
instantiate_processor (OMX_HANDLETYPE ap_hdl)
{
  ...
  TIZ_LOG (TIZ_LOG_TRACE, "Inititializing the test component's processor");
