...
find_default_uri (tiz_demuxer_cfgport_t *ap_obj)
{
  ...
  TIZ_LOGN (TIZ_TRACE, tiz_api_get_hdl (ap_obj), "Default URI [%s]...", p_uri);
    ...
    case OMX_IndexParamContentURI:
      {
        ...
        TIZ_LOGN (TIZ_TRACE, ap_hdl, "uri_buf_size [%d]...", uri_buf_size);
        TIZ_LOGN (TIZ_TRACE, ap_hdl, "p_obj->p_uri_ [%08x]...", p_obj->p_uri_);
