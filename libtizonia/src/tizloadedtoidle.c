...
static OMX_ERRORTYPE
loadedtoidle_ComponentDeInit (const void *ap_obj,
                                  OMX_HANDLETYPE ap_hdl)
{
  return OMX_ErrorNotImplemented;
}
                      ...
                      OMX_U32 a_param1, OMX_PTR ap_cmd_data)
{
  ...
  TIZ_LOG (TIZ_LOG_TRACE, "Requested transition [ESubStateLoadedToIdle -> %s]...",
  ...
  if (!tizloadedtoidle)
    {
      ...
      tizloadedtoidle =
        ...
        (tizstate_class, "tizloadedtoidle",
         ...
         tizapi_SetParameter, loadedtoidle_SetParameter,
         tizapi_GetState, loadedtoidle_GetState,
