...
{
  tiz_vorbisport_t *p_obj = super_ctor (typeOf (ap_obj, "tizvorbisport"), ap_obj, app);
...
vorbisport_GetParameter (const void *ap_obj,
    ...
    default:
      {
        ...
        return super_GetParameter (typeOf (ap_obj, "tizvorbisport"),
...
static OMX_ERRORTYPE
vorbisport_SetParameter (const void *ap_obj,
                      OMX_HANDLETYPE ap_hdl,
                      OMX_INDEXTYPE a_index, OMX_PTR ap_struct)
{
  ...
  switch (a_index)
    ...
    default:
      {
        /* Try the parent's indexes */
        return super_SetParameter (typeOf (ap_obj, "tizvorbisport"),
                                   ap_obj, ap_hdl, a_index, ap_struct);
      }
    };
