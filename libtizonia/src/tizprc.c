...
dispatch_br (void *ap_obj, OMX_PTR ap_msg)
{
  ...
  TIZ_TRACE (p_msg->p_hdl, "p_msg->p_hdl [%p] "
...
dispatch_config (void *ap_obj, OMX_PTR ap_msg)
{
  ...
  TIZ_TRACE (p_msg->p_hdl, "p_msg_cc->pid = [%d] p_port [%p]",
...
dispatch_dr (void *ap_obj, OMX_PTR ap_msg)
{
  ...
  if (EStateExecuting == now)
  ...
  else
    {
      ...
      */
      TIZ_DEBUG (p_msg->p_hdl, "Ignoring deferred resume "
...
static OMX_ERRORTYPE
prc_SendCommand (const void *ap_obj,
                  OMX_HANDLETYPE ap_hdl,
...
static OMX_ERRORTYPE
prc_SetConfig (const void *ap_obj,
               OMX_HANDLETYPE ap_hdl,
...
static OMX_ERRORTYPE
prc_io_ready (const void *ap_obj,
