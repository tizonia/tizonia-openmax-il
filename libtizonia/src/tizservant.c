...
{
  tiz_servant_t *p_obj = super_ctor (tizservant, ap_obj, app);
...
{
  const tiz_servant_class_t *superclass = super (a_class);
...
{
  const tiz_servant_t *p_obj = ap_obj;
...
{
  tiz_servant_class_t *p_obj = super_ctor (tizservant_class, ap_obj, app);
  typedef void (*voidf) ();
  voidf selector;
  va_list ap;
  va_copy (ap, *app);
