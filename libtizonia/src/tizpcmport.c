  ...
  if ((p_pcmmode = va_arg (*app, OMX_AUDIO_PARAM_PCMMODETYPE *)))
    {
      ...
      TIZ_LOG (TIZ_LOG_TRACE, "nChannels = [%d]",
      ...
      if (ap_other_def->format.audio.eEncoding != OMX_AUDIO_CodingPCM)
        {
          TIZ_LOG (TIZ_LOG_TRACE, "port [%d] check_tunnel_compat : "
                     ...
                     p_obj->pid_,
                     ap_other_def->format.audio.eEncoding);
          return OMX_FALSE;
        }
    }
      ...
      case OMX_IndexParamAudioPcm:
        {
          ...
          TIZ_LOG (TIZ_LOG_TRACE,"OMX_IndexParamAudioPcm : new sampling rate[%d] "
      ...
      case OMX_IndexParamAudioMp3:
        {
          ...
          TIZ_LOG (TIZ_LOG_TRACE,"OMX_IndexParamAudioMp3 : new sampling rate[%d] "
                   "new num channels[%d] new_bps[%d]",
                   new_rate, new_channels, new_bps);
        }
        break;
      ...
      case OMX_IndexParamAudioAac:
        {
          ...
          TIZ_LOG (TIZ_LOG_TRACE,"OMX_IndexParamAudioAac : new sampling rate[%d] "
                   "new num channels[%d] new_bps[%d]",
                   new_rate, new_channels, new_bps);
        }
        break;
      ...
      case OMX_IndexParamAudioVorbis:
        {
          ...
          TIZ_LOG (TIZ_LOG_TRACE,"OMX_IndexParamAudioVorbis : new sampling rate[%d] "
                   "new num channels[%d] new_bps[%d]",
                   new_rate, new_channels, new_bps);
        }
        break;
      ...
      case OMX_IndexParamAudioWma:
        {
          ...
          TIZ_LOG (TIZ_LOG_TRACE,"OMX_IndexParamAudioWma : new sampling rate[%d] "
                   "new num channels[%d] new_bps[%d]",
                   new_rate, new_channels, new_bps);
        }
        break;
      ...
      case OMX_IndexParamAudioRa:
        {
          ...
          TIZ_LOG (TIZ_LOG_TRACE,"OMX_IndexParamAudioRa : new sampling rate[%d] "
                   "new num channels[%d] new_bps[%d]",
                   new_rate, new_channels, new_bps);
        }
        break;
      ...
      case OMX_IndexParamAudioSbc:
        {
          ...
          TIZ_LOG (TIZ_LOG_TRACE,"OMX_IndexParamAudioSbc : new sampling rate[%d] "
                   "new num channels[%d] new_bps[%d]",
                   new_rate, new_channels, new_bps);
        }
        break;
      ...
      case OMX_IndexParamAudioAdpcm:
        {
          ...
          TIZ_LOG (TIZ_LOG_TRACE,"OMX_IndexParamAudioAdpcm : new sampling rate[%d] "
                   "new num channels[%d] new_bps[%d]",
                   new_rate, new_channels, new_bps);
        }
        break;
  ...
  if (!tizpcmport)
    {
      ...
      tizpcmport =
        ...
        (tizpcmport_class,
         ...
         tizport_apply_slaving_behaviour, pcmport_apply_slaving_behaviour,
         0);
    }
