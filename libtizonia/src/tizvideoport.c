        ...
        if (OMX_VIDEO_CodingUnused == p_obj->port_format_.eCompressionFormat)
          {
            ...
            TIZ_LOGN (TIZ_PRIORITY_TRACE, ap_hdl, "ColorFormat [%x]...", *p_format);
          }
        else
          {
            ...
            TIZ_LOGN (TIZ_PRIORITY_TRACE, ap_hdl, "CompressionFormat [%x] ", *p_encoding);
          }
                        ...
                        OMX_INDEXTYPE a_index, OMX_PTR ap_struct)
{
  ...
  TIZ_LOGN (TIZ_PRIORITY_TRACE, ap_hdl, "SetParameter [%s]...",
  ...
  if (OMX_IndexParamPortDefinition == a_index)
    {
      ...
      if ((OMX_DirOutput == p_base->portdef_.eDir)
        ...
        {
          TIZ_LOGN (TIZ_PRIORITY_ERROR, ap_hdl, "[OMX_ErrorBadParameter] : PORT [%d] "
        ...
        if (OMX_VIDEO_CodingUnused == p_obj->port_format_.eCompressionFormat)
          {
            ...
            if (!tiz_vector_find (p_obj->p_color_formats_, &format))
              {
                TIZ_LOGN (TIZ_PRIORITY_TRACE, ap_hdl, "OMX_ErrorUnsupportedSetting "
            ...
            TIZ_LOGN (TIZ_PRIORITY_TRACE, ap_hdl, "Set color format [0x%08x] "
        ...
        else
          {
            ...
            if (!tiz_vector_find (p_obj->p_video_encodings_, &encoding))
            ...
            else
              {
                ...
                TIZ_LOGN (TIZ_PRIORITY_TRACE, ap_hdl, "Set video encoding"
                         "[0x%08x]...", encoding);
              }
          }
