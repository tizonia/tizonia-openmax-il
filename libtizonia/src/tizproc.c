...
typedef OMX_ERRORTYPE (*tizproc_msg_dispatch_f) (void *ap_obj,
                                                 OMX_PTR ap_msg);
                   ...
                   tizproc_msg_class_t a_msg_class)
{
  ...
  if (NULL == (p_msg = tiz_servant_init_msg (p_obj, sizeof (tizproc_msg_t))))
    {
...
init_tizproc (void)
{
  ...
  if (!tizproc_class)
    {
      init_tizservant ();
      tizproc_class = factory_new (tiz_servant_class,
                                   "tizproc_class",
                                   tiz_servant_class,
