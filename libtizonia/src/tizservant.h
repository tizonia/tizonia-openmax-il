...
OMX_ERRORTYPE tiz_srv_allocate_resources (const void *ap_obj, OMX_U32 a_pid);

OMX_ERRORTYPE tiz_srv_deallocate_resources (const void *ap_obj);

OMX_ERRORTYPE tiz_srv_prepare_to_transfer (const void *ap_obj, OMX_U32 a_pid);

OMX_ERRORTYPE tiz_srv_transfer_and_process (const void *ap_obj, OMX_U32 a_pid);
...
OMX_ERRORTYPE tiz_srv_receive_pluggable_event (void *ap_obj,
