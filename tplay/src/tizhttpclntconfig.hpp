...
/**
 * @file   tizhttpclntconfig.hpp
 * @author Juan A. Rubio <juan.rubio@aratelia.com>
 *
 * @brief  OpenMAX IL HTTP Streaming client graph configuration
 *
 *
 */

#ifndef TIZHTTPCLNTCONFIG_HPP
#define TIZHTTPCLNTCONFIG_HPP
...
namespace tiz
{
  namespace graph
  {
    class httpclntconfig : public config
    {

    public:
      httpclntconfig (const tizplaylist_ptr_t &playlist,
