How to generate Tizonia's documentation
---------------------------------------

Tizonia's docs (doxygen docs, html site, and man page) are generated using the
Sphinx documentation system found in the repo's top-level 'docs' directory.


   # Install the dependencies
   $ sudo apt install doxygen graphviz default-jre
   $ sudo -H pip3 install --upgrade sphinx breathe alabaster recommonmark sphinxcontrib.plantuml
