...
#define COMPONENT_NAME "OMX.Aratelia.audio_renderer_nb.pcm"
...
init_test_data()
{
  ...
  p_testfile1 = tiz_rcfile_get_value("plugins-data",
                                     "OMX.Aratelia.audio_renderer_nb.pcm.testfile1_uri");
  p_testfile2 = tiz_rcfile_get_value("plugins-data",
                                     "OMX.Aratelia.audio_renderer_nb.pcm.testfile2_uri");
