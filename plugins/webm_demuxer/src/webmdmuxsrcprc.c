...
static OMX_ERRORTYPE webmdmuxsrc_prc_deallocate_resources (void *);
static OMX_ERRORTYPE release_buffer (webmdmuxsrc_prc_t *);
static OMX_ERRORTYPE prepare_for_port_auto_detection (webmdmuxsrc_prc_t *ap_prc);
...
static void update_cache_size (webmdmuxsrc_prc_t *ap_prc)
{
  assert (ap_prc);
...
static OMX_ERRORTYPE obtain_uri (webmdmuxsrc_prc_t *ap_prc)
{
  OMX_ERRORTYPE rc = OMX_ErrorNone;
...
static void obtain_audio_encoding_from_headers (webmdmuxsrc_prc_t *ap_prc,
...
static inline void delete_uri (webmdmuxsrc_prc_t *ap_prc)
{
  assert (ap_prc);
...
static OMX_ERRORTYPE release_buffer (webmdmuxsrc_prc_t *ap_prc)
{
  assert (ap_prc);
...
static void *webmdmuxsrc_prc_ctor (void *ap_prc, va_list *app)
{
...
static void *webmdmuxsrc_prc_dtor (void *ap_obj)
{
...
static OMX_ERRORTYPE webmdmuxsrc_prc_allocate_resources (void *ap_prc,
                                                      OMX_U32 a_pid)
{
...
static OMX_ERRORTYPE webmdmuxsrc_prc_deallocate_resources (void *ap_prc)
{
  webmdmuxsrc_prc_t *p_prc = ap_prc;
  assert (p_prc);
...
static OMX_ERRORTYPE webmdmuxsrc_prc_prepare_to_transfer (void *ap_prc,
                                                       OMX_U32 a_pid)
{
  webmdmuxsrc_prc_t *p_prc = ap_prc;
  assert (ap_prc);
...
static OMX_ERRORTYPE webmdmuxsrc_prc_transfer_and_process (void *ap_prc,
                                                        OMX_U32 a_pid)
{
  webmdmuxsrc_prc_t *p_prc = ap_prc;
  OMX_ERRORTYPE rc = OMX_ErrorNone;
...
static OMX_ERRORTYPE webmdmuxsrc_prc_stop_and_return (void *ap_prc)
{
  webmdmuxsrc_prc_t *p_prc = ap_prc;
  assert (p_prc);
  if (p_prc->p_trans_)
...
static OMX_ERRORTYPE webmdmuxsrc_prc_buffers_ready (const void *ap_prc)
{
...
static OMX_ERRORTYPE webmdmuxsrc_prc_io_ready (void *ap_prc,
...
static OMX_ERRORTYPE webmdmuxsrc_prc_timer_ready (void *ap_prc,
...
static OMX_ERRORTYPE webmdmuxsrc_prc_pause (const void *ap_obj)
{
  return OMX_ErrorNone;
}

static OMX_ERRORTYPE webmdmuxsrc_prc_resume (const void *ap_obj)
{
  return OMX_ErrorNone;
}

static OMX_ERRORTYPE webmdmuxsrc_prc_port_flush (const void *ap_obj,
...
static OMX_ERRORTYPE webmdmuxsrc_prc_port_disable (const void *ap_obj,
                                              OMX_U32 TIZ_UNUSED (a_pid))
{
  webmdmuxsrc_prc_t *p_prc = (webmdmuxsrc_prc_t *)ap_obj;
  assert (p_prc);
...
static OMX_ERRORTYPE webmdmuxsrc_prc_port_enable (const void *ap_prc, OMX_U32 a_pid)
{
  webmdmuxsrc_prc_t *p_prc = (webmdmuxsrc_prc_t *)ap_prc;
  OMX_ERRORTYPE rc = OMX_ErrorNone;
  assert (p_prc);
...
static void *webmdmuxsrc_prc_class_ctor (void *ap_prc, va_list *app)
{
