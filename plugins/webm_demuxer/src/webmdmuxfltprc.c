          ...
          if (p_hdr)
            {
              ...
              /* TODO: Possibly push each codec config element in a separate OMX buffer */
              memcpy (TIZ_OMX_BUF_PTR (p_hdr) + p_hdr->nFilledLen, p_codec_data,
                      MIN (TIZ_OMX_BUF_AVAIL (p_hdr), length));
