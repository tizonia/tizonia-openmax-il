...
instantiate_filter_webm_input_port (OMX_HANDLETYPE ap_hdl)
{
  ...
  return factory_new (tiz_get_type (ap_hdl, "tizwebmport"),
                      &port_opts, &encodings);
}
...
{
  return instantiate_audio_output_port (ap_hdl, ARATELIA_WEBM_DEMUXER_SOURCE_PORT_0_INDEX);
}

static OMX_PTR
instantiate_filter_audio_output_port (OMX_HANDLETYPE ap_hdl)
{
  return instantiate_audio_output_port (ap_hdl, ARATELIA_WEBM_DEMUXER_FILTER_PORT_1_INDEX);
}
...
{
  return instantiate_video_output_port (ap_hdl, ARATELIA_WEBM_DEMUXER_SOURCE_PORT_1_INDEX);
}

static OMX_PTR
instantiate_filter_video_output_port (OMX_HANDLETYPE ap_hdl)
{
  return instantiate_video_output_port (ap_hdl, ARATELIA_WEBM_DEMUXER_FILTER_PORT_2_INDEX);
}
