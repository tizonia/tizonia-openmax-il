...
static OMX_ERRORTYPE httpr_prc_config_change (const void *ap_prc, OMX_U32 a_pid,
...
static void buffer_emptied (OMX_BUFFERHEADERTYPE *ap_hdr, void *ap_arg)
{
  httpr_prc_t *p_prc = ap_arg;
...
static inline OMX_ERRORTYPE retrieve_mp3_settings (
...
static inline OMX_ERRORTYPE retrieve_mountpoint_settings (
...
static void *httpr_prc_dtor (void *ap_prc)
{
...
static OMX_ERRORTYPE httpr_prc_allocate_resources (void *ap_prc, OMX_U32 a_pid)
{
  ...
  return httpr_srv_init (&(p_prc->p_server_), p_prc,
                         ...
                         p_prc->server_info_.nMaxClients, buffer_emptied,
                         buffer_needed, p_prc);
}
...
static OMX_ERRORTYPE httpr_prc_prepare_to_transfer (void *ap_prc, OMX_U32 a_pid)
{
  httpr_prc_t *p_prc = ap_prc;
...
static OMX_ERRORTYPE httpr_prc_transfer_and_process (void *ap_prc,
                                                     OMX_U32 a_pid)
{
  return OMX_ErrorNone;
}

static OMX_ERRORTYPE httpr_prc_stop_and_return (void *ap_prc)
{
  httpr_prc_t *p_prc = ap_prc;
...
static OMX_ERRORTYPE httpr_prc_buffers_ready (const void *ap_prc)
{
...
static OMX_ERRORTYPE httpr_prc_port_enable (const void *ap_prc, OMX_U32 a_pid)
{
  httpr_prc_t *p_prc = (httpr_prc_t *)ap_prc;
...
static OMX_ERRORTYPE httpr_prc_port_disable (const void *ap_prc, OMX_U32 a_pid)
{
  httpr_prc_t *p_prc = (httpr_prc_t *)ap_prc;
...
static OMX_ERRORTYPE httpr_prc_config_change (const void *ap_prc,
                                              const OMX_U32 a_pid,
...
static void *httpr_prc_class_ctor (void *ap_prc, va_list *app)
{
