...
#define ARATELIA_PCM_RENDERER_NULL_ALSA_DEVICE     "null"
#define ARATELIA_PCM_RENDERER_DEFAULT_ALSA_DEVICE \
  ARATELIA_PCM_RENDERER_NULL_ALSA_DEVICE

#define ARATELIA_PCM_RENDERER_DEFAULT_RAMP_STEP_COUNT 20

#define ARATELIA_PCM_RENDERER_PULSEAUDIO_NAME "Tizonia PulseAudio PCM Renderer"
