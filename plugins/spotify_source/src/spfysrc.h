...
#define ARATELIA_SPOTIFY_SOURCE_DEFAULT_ROLE         "audio_source.spotify"
#define ARATELIA_SPOTIFY_SOURCE_COMPONENT_NAME       "OMX.Aratelia.audio_source.spotify"
/* With libtizonia, port indexes must start at index 0 */
#define ARATELIA_SPOTIFY_SOURCE_PORT_INDEX           0
#define ARATELIA_SPOTIFY_SOURCE_PORT_MIN_BUF_COUNT   2
#define ARATELIA_SPOTIFY_SOURCE_PORT_MIN_BUF_SIZE    8192
