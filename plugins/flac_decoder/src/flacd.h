...
#define ARATELIA_FLAC_DECODER_PORT_MIN_INPUT_BUF_SIZE  128*1024
#define ARATELIA_FLAC_DECODER_PORT_MIN_OUTPUT_BUF_SIZE 8192 * 20
#define ARATELIA_FLAC_DECODER_BUFFER_THRESHOLD         ARATELIA_FLAC_DECODER_PORT_MIN_INPUT_BUF_SIZE * (ARATELIA_FLAC_DECODER_PORT_MIN_BUF_COUNT - 1)
