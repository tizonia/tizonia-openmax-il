...
static OMX_ERRORTYPE alloc_temp_data_store (flacd_prc_t *ap_prc)
{
...
static inline void dealloc_temp_data_store (/*@special@ */ flacd_prc_t *ap_prc)
...
static inline OMX_BUFFERHEADERTYPE **get_header_ptr (flacd_prc_t *ap_prc,
                                                     const OMX_U32 a_pid)
{
...
static inline bool *get_port_disabled_ptr (flacd_prc_t *ap_prc,
                                           const OMX_U32 a_pid)
{
...
static OMX_BUFFERHEADERTYPE *get_header (flacd_prc_t *ap_prc,
                                         const OMX_U32 a_pid)
{
...
static void release_header (flacd_prc_t *ap_prc, const OMX_U32 a_pid)
{
  OMX_BUFFERHEADERTYPE **pp_hdr = get_header_ptr (ap_prc, a_pid);
  OMX_BUFFERHEADERTYPE *p_hdr = NULL;
...
static int store_data (flacd_prc_t *ap_prc, const OMX_U8 *ap_data,
                       OMX_U32 a_nbytes)
{
  OMX_U8 **pp_store = NULL;
  OMX_U32 *p_offset = NULL;
...
static inline bool input_data_available (flacd_prc_t *ap_prc)
{
  OMX_BUFFERHEADERTYPE *p_hdr = NULL;
  bool done = false;
...
static inline OMX_ERRORTYPE do_flush (flacd_prc_t *ap_prc)
{
...
static OMX_ERRORTYPE transform_stream (const flacd_prc_t *ap_prc)
{
...
static int dump_temp_store (flacd_prc_t *ap_prc, OMX_U8 *ap_buffer,
                            size_t nbytes_avail)
{
  OMX_U8 *p_store = NULL;
  OMX_U32 *p_offset = NULL;
...
static FLAC__StreamDecoderReadStatus read_cb (
    const FLAC__StreamDecoder *ap_decoder, FLAC__byte buffer[],
...
static void metadata_cb (const FLAC__StreamDecoder *ap_decoder,
                         const FLAC__StreamMetadata *ap_metadata,
                         void *ap_client_data)
{
  flacd_prc_t *p_prc = (flacd_prc_t *)ap_client_data;
...
static void error_cb (const FLAC__StreamDecoder *ap_decoder,
...
static void *flacd_prc_dtor (void *ap_obj)
{
...
static OMX_ERRORTYPE flacd_prc_prepare_to_transfer (void *ap_obj, OMX_U32 a_pid)
{
  flacd_prc_t *p_prc = ap_obj;
...
static OMX_ERRORTYPE flacd_prc_transfer_and_process (void *ap_obj,
                                                     OMX_U32 a_pid)
{
  return OMX_ErrorNone;
}
...
static OMX_ERRORTYPE flacd_prc_buffers_ready (const void *ap_obj)
{
...
static void *flacd_prc_class_ctor (void *ap_obj, va_list *app)
{
