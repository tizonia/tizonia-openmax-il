...
#include "cc_dirblecfgport_decls.h"

#ifdef TIZ_LOG_CATEGORY_NAME
#undef TIZ_LOG_CATEGORY_NAME
#define TIZ_LOG_CATEGORY_NAME "tiz.chromecast_renderer.cfgport.dirble"
#endif

/*
 * cc_dirblecfgport class
 */
                             ...
                             OMX_INDEXTYPE a_index, OMX_PTR ap_struct)
{
  ...
  if (OMX_TizoniaIndexParamAudioDirbleSession == a_index)
  ...
  else
    {
      ...
      rc = super_GetParameter (typeOf (ap_obj, "cc_dirblecfgport"), ap_obj,
                             ...
                             OMX_INDEXTYPE a_index, OMX_PTR ap_struct)
{
  ...
  if (OMX_TizoniaIndexParamAudioDirbleSession == a_index)
    ...
    {
      /* Delegate to the base port */
      rc = super_SetParameter (typeOf (ap_obj, "cc_dirblecfgport"), ap_obj,
                               ap_hdl, a_index, ap_struct);
    }
