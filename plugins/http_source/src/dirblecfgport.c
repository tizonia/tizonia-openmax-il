...
static void *dirble_cfgport_ctor (void *ap_obj, va_list *app)
{
  ...
  tiz_check_omx_err_ret_null (tiz_port_register_index (
      p_obj, OMX_TizoniaIndexParamAudioDirbleSession));
  tiz_check_omx_err_ret_null (tiz_port_register_index (
      p_obj, OMX_TizoniaIndexParamAudioDirblePlaylist));

  /* Initialize the OMX_TIZONIA_AUDIO_PARAM_DIRBLESESSIONTYPE structure */
  TIZ_INIT_OMX_STRUCT (p_obj->session_);
  snprintf ((char *)p_obj->session_.cApiKey,
            sizeof(p_obj->session_.cApiKey), "xyzxyzxyzxyzxyz");
...
dirble_cfgport_GetParameter (const void *ap_obj,
                           ...
                           OMX_INDEXTYPE a_index, OMX_PTR ap_struct)
{
  ...
  if (OMX_TizoniaIndexParamAudioDirbleSession == a_index)
  ...
  else
    {
      ...
      rc = super_GetParameter (typeOf (ap_obj, "dirblecfgport"),
...
static OMX_ERRORTYPE
dirble_cfgport_SetParameter (const void *ap_obj,
                           OMX_HANDLETYPE ap_hdl,
                           OMX_INDEXTYPE a_index, OMX_PTR ap_struct)
{
  ...
  if (OMX_TizoniaIndexParamAudioDirbleSession == a_index)
    {
      ...
      TIZ_TRACE (ap_hdl, "Dirble Api Key [%s]...",
                 p_obj->session_.cApiKey);
    }
  else if (OMX_TizoniaIndexParamAudioDirblePlaylist == a_index)
    {
    ...
    {
      /* Delegate to the base port */
      rc = super_SetParameter (typeOf (ap_obj, "dirblecfgport"),
                               ap_obj, ap_hdl, a_index, ap_struct);
    }
...
dirble_cfgport_class_init (void * ap_tos, void * ap_hdl)
{
  ...
  void * dirblecfgport_class = factory_new (classOf (tizconfigport),
                                          "dirblecfgport_class",
                                          classOf (tizconfigport),
                                          sizeof (dirble_cfgport_class_t),
                                          ap_tos, ap_hdl,
                                          ctor, dirble_cfgport_class_ctor, 0);
...
dirble_cfgport_init (void * ap_tos, void * ap_hdl)
{
  ...
  void * dirblecfgport = factory_new
    ...
    (dirblecfgport_class, "dirblecfgport", tizconfigport, sizeof (dirble_cfgport_t),
