...
#include "iheartcfgport_decls.h"

#ifdef TIZ_LOG_CATEGORY_NAME
#undef TIZ_LOG_CATEGORY_NAME
#define TIZ_LOG_CATEGORY_NAME "tiz.http_source.cfgport.iheart"
#endif
...
static void *
iheart_cfgport_ctor (void * ap_obj, va_list * app)
{
  iheart_cfgport_t * p_obj
    = super_ctor (typeOf (ap_obj, "iheartcfgport"), ap_obj, app);
...
static void *
iheart_cfgport_dtor (void * ap_obj)
{
  return super_dtor (typeOf (ap_obj, "iheartcfgport"), ap_obj);
}
...
iheart_cfgport_GetParameter (const void * ap_obj, OMX_HANDLETYPE ap_hdl,
                             OMX_INDEXTYPE a_index, OMX_PTR ap_struct)
{
  const iheart_cfgport_t * p_obj = ap_obj;
  ...
  if (OMX_TizoniaIndexParamAudioIheartSession == a_index)
  ...
  else
    {
      ...
      rc = super_GetParameter (typeOf (ap_obj, "iheartcfgport"), ap_obj, ap_hdl,
                               a_index, ap_struct);
    }
...
static OMX_ERRORTYPE
iheart_cfgport_SetParameter (const void * ap_obj, OMX_HANDLETYPE ap_hdl,
                             OMX_INDEXTYPE a_index, OMX_PTR ap_struct)
{
  iheart_cfgport_t * p_obj = (iheart_cfgport_t *) ap_obj;
  OMX_ERRORTYPE rc = OMX_ErrorNone;
  ...
  if (OMX_TizoniaIndexParamAudioIheartSession == a_index)
    ...
    {
      /* Delegate to the base port */
      rc = super_SetParameter (typeOf (ap_obj, "iheartcfgport"), ap_obj, ap_hdl,
                               a_index, ap_struct);
    }
...
/*
 * iheart_cfgport_class
 */

static void *
iheart_cfgport_class_ctor (void * ap_obj, va_list * app)
{
  /* NOTE: Class methods might be added in the future. None for now. */
  return super_ctor (typeOf (ap_obj, "iheartcfgport_class"), ap_obj, app);
}
...
iheart_cfgport_class_init (void * ap_tos, void * ap_hdl)
{
  ...
  void * iheartcfgport_class
    = factory_new (classOf (tizconfigport), "iheartcfgport_class",
                   classOf (tizconfigport), sizeof (iheart_cfgport_class_t),
                   ap_tos, ap_hdl, ctor, iheart_cfgport_class_ctor, 0);
  return iheartcfgport_class;
}
...
{
  void * tizconfigport = tiz_get_type (ap_hdl, "tizconfigport");
  void * iheartcfgport_class = tiz_get_type (ap_hdl, "iheartcfgport_class");
  TIZ_LOG_CLASS (iheartcfgport_class);
  void * iheartcfgport = factory_new
    /* TIZ_CLASS_COMMENT: class type, class name, parent, size */
    (iheartcfgport_class, "iheartcfgport", tizconfigport,
     sizeof (iheart_cfgport_t),
     /* TIZ_CLASS_COMMENT: class constructor */
     ap_tos, ap_hdl,
     /* TIZ_CLASS_COMMENT: class constructor */
     ctor, iheart_cfgport_ctor,
     /* TIZ_CLASS_COMMENT: class destructor */
     dtor, iheart_cfgport_dtor,
     /* TIZ_CLASS_COMMENT: */
     tiz_api_GetParameter, iheart_cfgport_GetParameter,
     /* TIZ_CLASS_COMMENT: */
     tiz_api_SetParameter, iheart_cfgport_SetParameter,
     /* TIZ_CLASS_COMMENT: stop value*/
     0);

  return iheartcfgport;
}
