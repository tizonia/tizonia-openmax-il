...
#define ARATELIA_MP3_METADATA_ERASER_INPUT_PORT_INDEX         0
#define ARATELIA_MP3_METADATA_ERASER_OUTPUT_PORT_INDEX        1
#define ARATELIA_MP3_METADATA_ERASER_PORT_MIN_BUF_COUNT       2
#define ARATELIA_MP3_METADATA_ERASER_PORT_MIN_INPUT_BUF_SIZE  8192
#define ARATELIA_MP3_METADATA_ERASER_PORT_MIN_OUTPUT_BUF_SIZE 8192
