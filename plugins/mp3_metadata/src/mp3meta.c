...
instantiate_input_port (OMX_HANDLETYPE ap_hdl)
{
  ...
  tiz_port_options_t mp3_port_opts = {
    ...
    ARATELIA_MP3_METADATA_ERASER_PORT_MIN_INPUT_BUF_SIZE,
    ...
    {ARATELIA_MP3_METADATA_ERASER_INPUT_PORT_INDEX, NULL, NULL, NULL},
...
instantiate_output_port (OMX_HANDLETYPE ap_hdl)
{
  ...
  tiz_port_options_t mp3_port_opts = {
    ...
    OMX_DirOutput,
    ARATELIA_MP3_METADATA_ERASER_PORT_MIN_BUF_COUNT,
    ARATELIA_MP3_METADATA_ERASER_PORT_MIN_OUTPUT_BUF_SIZE,
    ARATELIA_MP3_METADATA_ERASER_PORT_NONCONTIGUOUS,
    ARATELIA_MP3_METADATA_ERASER_PORT_ALIGNMENT,
    ARATELIA_MP3_METADATA_ERASER_PORT_SUPPLIERPREF,
    {ARATELIA_MP3_METADATA_ERASER_OUTPUT_PORT_INDEX, NULL, NULL, NULL},
    0                           /* Master port */
  };
...
OMX_ComponentInit (OMX_HANDLETYPE ap_hdl)
{
  ...
  TIZ_LOG (TIZ_PRIORITY_TRACE, "OMX_ComponentInit: "
           "Inititializing [%s]", ARATELIA_MP3_METADATA_ERASER_COMPONENT_NAME);

  strcpy ((OMX_STRING) role_factory.role, ARATELIA_MP3_METADATA_ERASER_DEFAULT_ROLE);
  ...
  tiz_check_omx_err (tiz_comp_init (ap_hdl, ARATELIA_MP3_METADATA_ERASER_COMPONENT_NAME));
