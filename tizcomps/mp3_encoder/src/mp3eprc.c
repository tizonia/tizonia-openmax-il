...
set_lame_mp3_settings(void *ap_obj, OMX_HANDLETYPE ap_hdl, void *ap_krn)
{
  ...
  TIZ_LOG (TIZ_LOG_TRACE, "nChannels = [%d] nBitRate = [%d] "
           ...
           p_obj->mp3type_.eChannelMode,
           p_obj->mp3type_.eFormat);
  ...
  if (!mp3eprc)
    {
      ...
      mp3eprc =
        ...
        (tizproc_class,
         ...
         ctor, mp3e_proc_ctor,
         dtor, mp3e_proc_dtor,
         tizservant_allocate_resources, mp3e_proc_allocate_resources,
         tizservant_deallocate_resources, mp3e_proc_deallocate_resources,
         tizservant_prepare_to_transfer, mp3e_proc_prepare_to_transfer,
         tizservant_transfer_and_process, mp3e_proc_transfer_and_process,
         tizservant_stop_and_return, mp3e_proc_stop_and_return,
