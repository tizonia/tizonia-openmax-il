...
vp8e_proc_ctor (void *ap_obj, va_list * app)
{
  ...
  TIZ_LOG (TIZ_LOG_TRACE, "Constructing vp8eprc...[%p]", p_obj);
...
vp8e_proc_dtor (void *ap_obj)
{
  ...
  TIZ_LOG (TIZ_LOG_TRACE, "Destructing vp8eprc...[%p]", p_obj);
...
init_vp8eprc (void)
{
  ...
  if (!vp8eprc)
    {
      TIZ_LOG (TIZ_LOG_TRACE, "Initializing vp8eprc...");
      init_tizproc ();
      vp8eprc =
        factory_new
        (tizproc_class,
         ...
         tizservant_allocate_resources, vp8e_proc_allocate_resources,
         tizservant_deallocate_resources, vp8e_proc_deallocate_resources,
         tizservant_prepare_to_transfer, vp8e_proc_prepare_to_transfer,
         tizservant_transfer_and_process, vp8e_proc_transfer_and_process,
         tizservant_stop_and_return, vp8e_proc_stop_and_return, 0);
    }
