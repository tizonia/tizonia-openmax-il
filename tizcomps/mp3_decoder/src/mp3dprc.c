...
/*       TIZ_LOG (TIZ_TRACE, tiz_servant_get_hdl (p_obj), */
...
{
  void *p_krn = tiz_get_krn (tiz_servant_get_hdl (ap_obj));
  tiz_pd_set_t ports;
  ...
  if (!mp3dprc)
    {
      ...
      mp3dprc =
        ...
        (tizproc_class,
         ...
         tiz_servant_deallocate_resources, mp3d_proc_deallocate_resources,
