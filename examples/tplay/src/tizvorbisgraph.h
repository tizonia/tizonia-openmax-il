...
/**
 * @file   tizvorbisgraph.h
 * @author Juan A. Rubio <juan.rubio@aratelia.com>
 *
 * @brief  OpenMAX IL vorbis graph class
 *
 *
 */
...
class tizvorbisgraph : public tizgraph
{

public:

  tizvorbisgraph (tizprobe_ptr_t probe_ptr);
...
private:
  ...
  OMX_ERRORTYPE configure_vorbis_graph (const int file_index);
