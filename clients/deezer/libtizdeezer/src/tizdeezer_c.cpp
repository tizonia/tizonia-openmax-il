...
extern "C" int tiz_deezer_play_mix (tiz_deezer_t *ap_deezer, const char *ap_mix)
{
  assert (ap_deezer);
  assert (ap_deezer->p_proxy_);
...
extern "C" int tiz_deezer_play_playlist (tiz_deezer_t *ap_deezer,
...
extern "C" int tiz_deezer_play_user_flow (tiz_deezer_t *ap_deezer)
{
  assert (ap_deezer);
  assert (ap_deezer->p_proxy_);
  return ap_deezer->p_proxy_->play_user_flow ();
}
