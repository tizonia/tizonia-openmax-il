...
#ifndef TIZPANDORA_HPP
#define TIZPANDORA_HPP
...
public:
  tizpandora (const std::string &base_url, const std::string &auth_token);
  ~tizpandora ();
...
private:
  ...
  boost::python::object py_pandora_proxy_;
};

#endif  // TIZPANDORA_HPP
