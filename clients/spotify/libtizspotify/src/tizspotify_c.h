...
/**
 * Add a Spotify Web stream to the playback queue.
 *
...
/**
 * Add all the streams_ of a Spotify playlist to the playback queue.
 *
 * After calling this method, the various tiz_spotify_get* methods can be
 * used to interact with the playback queue.
 *
 ...
 * @return 0 on success
 */
int tiz_spotify_play_playlist (tiz_spotify_t *ap_spotify, const char *ap_playlist);
 ...
 * empty.
 */
const char *tiz_spotify_get_next_url (tiz_spotify_t *ap_spotify,
 ...
 * is empty.
 */
const char *tiz_spotify_get_prev_url (tiz_spotify_t *ap_spotify,
                                   const bool a_remove_current_url);
